...
export class GreekModeDictionary {
  ...
  private constructor() {
    this.modes = {
      ...
      [GreekModeType.PhrygianDominant]: new GreekModeInfo(
        GreekModeType.PhrygianDominant,
        GREEK_MODE_PATTERNS.PHRYGIAN_DOMINANT,
        3
      ),
      [GreekModeType.Byzantine]: new GreekModeInfo(
        GreekModeType.Byzantine,
        GREEK_MODE_PATTERNS.BYZANTINE,
        3
      ),
